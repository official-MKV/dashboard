...
import { earningData,SparklineAreaData,ecomPieChart, contextMenuItems } from '../Data/dummy'
          ...
          '>
              <div className='flex justify-between items-center'>
                <div>
                  ...
                  <p className='text-2xl '>$65,459,400.00</p>
                </div>
              </div>
              <div className='mt-6'>
                <Button 
           ...
           dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl md:w-780'>
            ...
            <div className='mt-4 flex gap-10 flex-wrap justify-center'>
              <div className='border-r-1 border-color m-4 pr-10'>
                ...
                <div className='mt-8'>
                  <p>
                    <span className='text-3xl font-semibold'>$40,439</span>
                  </p>
                  <p className='text-gray-500 mt-1'>
                    Expense
                  </p>
